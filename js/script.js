...
const iconCategories = {
    ...
    'Home & Family': ['fa-house', 'fa-baby', 'fa-child', 'fa-children', 'fa-user-group', 'fa-users', 'fa-person-cane', 'fa-person-walking-with-cane', 'fa-wheelchair', 'fa-kitchen-set', 'fa-bath', 'fa-bed', 'fa-couch', 'fa-chair', 'fa-tv', 'fa-plug', 'fa-lightbulb', 'fa-fan', 'fa-jug-detergent'],
